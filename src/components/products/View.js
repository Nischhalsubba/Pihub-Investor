          ...
          <div class="content-body credit-request">
            <div class="row justify-content-between w-100">
              <div class="col-lg-12 col-xl-8">
                <p>
                  In computer programming, a placeholder is a character, word,
                  or string of characters that may be used to take up space
                  until such a time that the space is needed. For example, a
                  programmer may know that she needs a certain number of values
                  or variables, but doesn't yet know what to input. She can use
                  a placeholder as a temporary solution until a proper value or
                ...
                <p>
                  ...
                  not yet written the code. The placeholder reminds the
                  programmer where to add the code, or it can be include to let
                  other programmers know that additional code still needs to be
                  added any programmer in general.
                </p>
                <p>
                  ...
                  an e-mail spam filter, or reserve a specific place on a web
                  page or other document for images, text, or some other object.
                  For example, the designer of an online newsletter may have a
                  template that they fill with dummy text so they can get an
                  idea of how the layout of a page looks. One of the most common
                  filler texts is lorem ipsum
                </p>
                <p>
                  Placeholders may also be commented out to prevent the computer
                  program from executing part of the code.Alternatively referred
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-right-piehub-table">
                      <a class="mr-1" href="">
                        <img
                          src="assets/img/icons/bx-check-circle.svg"
                          alt="accepted"
                        />
                      </a>
                      <a href="">
                        {' '}
                        <img
                          src="assets/img/icons/bx-x-circle.svg"
                          alt="rejected"
                        />
                      </a>
                    </td>
