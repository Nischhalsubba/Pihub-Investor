...
const OpportunityToolbar = props => {
  ...
  const allLabel = getLocale() === 'de' ? 'Alle' : 'All';
  return <div className="data-toolbar" aria-label="Opportunity view tools">
    ...
    <div className="data-toolbar-actions">
      ...
      <button type="button" className="btn btn-secondary" onClick={onExport}><i className="bx bx-download" aria-hidden="true" /> Export CSV</button>
